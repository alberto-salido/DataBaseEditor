 ...
 * <ul>
 *   <li>{@link defaultname.DataBaseElement#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @see defaultname.DefaultnamePackage#getDataBaseElement()
 * @model abstract="true"
...
public interface DataBaseElement extends EObject
{
   ...
   * @see #setName(String)
   * @see defaultname.DefaultnamePackage#getDataBaseElement_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link defaultname.DataBaseElement#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
