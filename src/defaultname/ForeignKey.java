 ...
 * <ul>
 *   <li>{@link defaultname.ForeignKey#getColumn <em>Column</em>}</li>
 *   <li>{@link defaultname.ForeignKey#getReference <em>Reference</em>}</li>
 * </ul>
 * </p>
 *
 * @see defaultname.DefaultnamePackage#getForeignKey()
...
public interface ForeignKey extends EObject
{
   ...
   * @see defaultname.DefaultnamePackage#getForeignKey_Column()
   * @model required="true"
   * @generated
   */
  Column getColumn();
  ...
  /**
   * Sets the value of the '{@link defaultname.ForeignKey#getColumn <em>Column</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see defaultname.DefaultnamePackage#getForeignKey_Reference()
   * @model required="true"
   * @generated
   */
  Table getReference();
  ...
  /**
   * Sets the value of the '{@link defaultname.ForeignKey#getReference <em>Reference</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
