...
public class ColumnImpl extends DataBaseElementImpl implements Column
{
   ...
   * @ordered
   */
  protected static final RailsData TYPE_EDEFAULT = RailsData.BINARY;
   ...
   * @ordered
   */
  protected RailsData type = TYPE_EDEFAULT;
   ...
   * @generated
   */
  public void setType(RailsData newType)
  {
    RailsData oldType = type;
